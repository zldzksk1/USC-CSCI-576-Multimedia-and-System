...
class Ui_Dialog(object):
    ...
    def extractScenes(self):
        ...
        frame_features = np.vstack([np.hstack((extract_color_histogram_features(med_frame), extract_hog_features(med_frame))) for med_frame in self.shot_frames_med_bgr])
